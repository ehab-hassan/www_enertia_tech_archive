    ...
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#provider_name option[value="+response.data.station_Provider+"]").attr('selected', 'selected');
                $("#from_day_time option[value="+response.data.station_from_day+"]").attr('selected', 'selected');
                $("#to_day_time option[value="+response.data.station_to_day+"]").attr('selected', 'selected');
                $("#from_time option[value='"+response.data.station_from_time+"']").attr('selected', 'selected');
                $("#to_time option[value='"+response.data.station_to_time+"']").attr('selected', 'selected');
                ...
                $("#payments option[value="+response.data.station_payment+"]").attr('selected', 'selected');
                $("#price").val(response.data.station_price);
                $("#access_type option[value="+response.data.station_accesstype+"]").attr('selected', 'selected');
