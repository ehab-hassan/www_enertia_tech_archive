    ...
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#from_time1 option[value="+response.data.station_from_time.split(':')[0]+"]").attr('selected', 'selected');
                $("#to_time1 option[value="+response.data.station_to_time.split(':')[0]+"]").attr('selected', 'selected');
