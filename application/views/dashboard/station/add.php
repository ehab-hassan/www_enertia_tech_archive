                                    ...
                                    <div class="col-md-12">
                                        <div class="container">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-12">
                                                    <input id="station_Name" name="station_Name" type="text" class="form-control" required="required">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="container">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-12">
                                                    <input id="provider_name" name="provider_name" type="text" class="form-control" required="required">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="container">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-12">
                                                    <input name="payments" id="payments" type="text" class="form-control" required="required">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="container">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-12">
                                                    <input id="access_type" name="access_type" type="text" class="form-control" required="required">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="container">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-12">
                                                        <input id="plug_type" name="plug_type[]" type="text" class="form-control" required="required">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="container">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-12">
                                                        <input id="charge_level" name="charge_level[]" type="text" class="form-control" required="required">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="container">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <input id="supply_type" name="supply_type[]" type="text" class="form-control" required="required">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="container">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-12">
                                                        <input id="max_voltage" name="max_voltage[]" type="text" class="form-control" required="required">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="container">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <input id="no_of_points" name="no_of_points[]" type="text" class="form-control" required="required">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
