                    ...
                    <form class="form-horizontal my-2" action="#" method="post">
                        ...
                        <div  class="form-group mb-0 row">
                            ...
                            <div class="col-12 mt-2">
                                ...
                                <button type="button" class="btn btn-primary btn-block waves-effect waves-light hide submit_to_action" id="submit_to_register" name="register" value="Register" >Join to Contribute<i class="fa fa-sign-in ml-1"></i></button>
                                <input type="hidden" name="userid" id="userid" value="">
                            </div>
                            <div class="col-12 mt-2">
                                <button type="button" class="btn btn-primary btn-block waves-effect waves-light" id="prevBtn" onclick="nextPrev(-1)">Go Back</button>
                            </div>
